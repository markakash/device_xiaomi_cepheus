...
# Fstab
PRODUCT_COPY_FILES += \
    device/xiaomi/cepheus/rootdir/etc/fstab.qcom:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.qcom

# whitelisted app
PRODUCT_COPY_FILES += \
    device/xiaomi/cepheus/qti_whitelist.xml:system/etc/sysconfig/qti_whitelist.xml

PRODUCT_COPY_FILES += \
    device/xiaomi/cepheus/privapp-permissions-qti.xml:system/etc/permissions/privapp-permissions-qti.xml
